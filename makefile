...
# SETUP
setup: install-docker restart-docker install-docker-compose verify-docker \ # docker
       download-nginx-config create-env-file modify-nginx-config \ # templating
       modify-certbot-service # cert
